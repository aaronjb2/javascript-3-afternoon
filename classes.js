...
var AA = new Employee("Aaron","Braithwaite",'aaronjbraithwaite@gmail.com',28);
...
class ProgressiveManager
{
  ...
  updateTitle()
  {
    this.title = this.reports.length == 0? 'Not a manager':this.reports.length <= 3? 'Barely Manager':this.reports.length <= 10? 'Mostly Manager':this.reports.length <= 50? 'Manager': this.reports.length <= 100? 'Manager Plus':'Bestest Manager';
  }
}
