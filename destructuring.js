...
var largeNumbers = ({first,second,third}) => first <=second && first<= third?first:second<=first && second<=third?second:third;
...
var numberGroups = ({a,b,c}) => a.length>=b.length && a.length >= c.length? a: b.length >= a.length && b.length >= c.length?b:c;
